Shader "Unlit/Noise"
{
    Properties
    {
        ...
        [HideInInspector] _NoiseType("Nise type", Int) = 0
            ...
            v2f vert(appdata v)
            {
                ...
                if(_Enabled == 1){
                    ...
                    for (int i = 0; i < _Octaves; i++)
                    {
                        ...
                        if (_NoiseType == 0) {
                            noiseSample = (ClassicNoise(float2(xValue + _WidthOffset, zValue + _HeightOffset)) * 2) - 1;
                        }
                        else if (_NoiseType == 1) {
                            noiseSample = (SimplexNoise(float2(xValue + _WidthOffset, zValue + _HeightOffset)) * 2) - 1;
                        }
